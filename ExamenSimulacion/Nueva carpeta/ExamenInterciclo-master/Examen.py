...
##Recinto Electoral Universidad Politecnica Salesiana (Cuenca - Ecuador)
#Aproximadamente 
...
class Vacunas():
    def __init__(self,sdas):
        ...
        self.electores = self.pacientes(self.electores)
        
    def pacientes(self,electores):    
        sinv = 1-random.randint(5,10)/100
        self.electores = self.electores * sinv
